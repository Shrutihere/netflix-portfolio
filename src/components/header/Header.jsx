...
import ME2 from '../../assets/shakshi.png'
  ...
  return (
    <header>
      <div className="container header__container">
        ...
        <div className='top'>
          {/* <div><h1 className='top_name'>SHAKSHI</h1></div> */}
          <div><img src={ME2} alt="" className='top_name'/></div>
          <div className='logo'>
        ...
        <div className="header">
          ...
          <div className='header__content'>
            ...
            <h1>SHAKSHI</h1>
            <h1>JAIN</h1>
            <h2 className="text-light">BRAND ARCHITECT</h2>
            <CTA/>
            {/* <HeaderSocials/> */}
          </div>
